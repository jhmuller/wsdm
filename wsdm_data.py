...
def main():
    ...
    # add to model
    model = train
    cols = ["msno", "bd", "gen_male", "gen_female", "gen_unk", "months_since_reg"] # "registered_via", "months_since_reg"]
    ...
    cols = ["msno", "is_churn", "payment_method_id", "payment_plan_days", "plan_list_price",
